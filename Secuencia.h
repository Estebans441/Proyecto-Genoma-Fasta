...
//Lista de atributos:
  ...
  string descripcion;
  // Multi-Lista que contiene todas las líneas genéticas pertenecientes a la Secuencia.
  /*
...
// Metodos Getters and Setters:
  ...
  list<Histograma> getHistograma() { if(histograma.empty()) generarHistograma(); return histograma; }
  ...
  // Metodo Constructor
  Secuencia(string desc, list<list<char>> l, bool completa, int n, int longitud, int identacion) {
    descripcion = desc;
    listaSecuencia = l;
...
// Metodos para cumplir con los requisitos
  ...
  */
  ...
  /*
    -------------------------------------------------------------------
    S e c u e n c i a : : g e t H i s t o g r a m a S t r i n g -> l i s t < s t r i n g >
    -------------------------------------------------------------------
